    ...
    return (
        <div id='services' className="services-section">
            ...
            <div className="boxes-wrapper">
                <div className="box">
                    <img src="/LandingPage/assets/icons/check.svg" width="59" height="59" alt="check" />
                    <h4>Dynamic <br />Landing Pages</h4>
                    <img src="/LandingPage/assets/icons/minus.svg" width="25" height="25" alt="minus" />
                    <p>We design and develop dynamic landing pages with live feeds.</p>
                </div>
                <div className="box">
                    <img src="/LandingPage/assets/icons/check.svg" width="59" height="59" alt="check" />
                    <h4>3D Visuals</h4><br />
