    ...
    return (
        <div className="services-section">
            ...
            <div className="boxes-wrapper">
                <div className="box">
                    <img src="/assets/icons/checkhighlights.svg" width="59" height="59" alt="check" />
                    <h4>Dynamic <br />Digital Ads</h4>
                    <img src="/assets/icons/minus.svg" width="25" height="25" alt="minus" />
                ...
                <div className="box">
                    <img src="/assets/icons/checkhighlights.svg" width="59" height="59" alt="check" />
                    <h4>Web <br />Assets</h4>
                    <img src="/assets/icons/plus.svg" width="25" height="25" alt="plus" />
